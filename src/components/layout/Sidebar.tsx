...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    allowedRoles: ['admin', 'manager', 'user'],
    items: [
      { label: 'Donation Requests', path: ROUTES.REQUESTS,        icon: <ClipboardList size={18} />, allowedRoles: ['admin'] },
      { label: 'My Requests',       path: ROUTES.REQUESTS,        icon: <ClipboardList size={18} />, allowedRoles: ['user'] },
      { label: 'Match Donors',      path: ROUTES.WORKFLOW_MATCH,  icon: <Target size={18} />,        allowedRoles: ['admin'] },
      { label: 'Hospitals',         path: ROUTES.MASTER_HOSPITALS, icon: <Hospital size={18} />,    allowedRoles: ['admin'] },
      { label: 'Blood Camps & Banks', path: ROUTES.MASTER_CAMPS,  icon: <Building2 size={18} />,    allowedRoles: ['admin'] },
